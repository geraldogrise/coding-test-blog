...
public interface IUserRepository
{
    ...
    public Task<Ambev.DeveloperEvaluation.Common.Result.PagedResult<User>> GetAllAsync(int page, int size, string order, CancellationToken cancellationToken = default);
}
