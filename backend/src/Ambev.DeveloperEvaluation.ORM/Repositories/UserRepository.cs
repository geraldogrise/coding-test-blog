...
public class UserRepository : IUserRepository
{
    ...
    public async Task<Ambev.DeveloperEvaluation.Common.Result.PagedResult<User>> GetAllAsync(int page, int size, string order, CancellationToken cancellationToken = default)
    {
        ...
        return new Ambev.DeveloperEvaluation.Common.Result.PagedResult<User>
        {
            Data = items,
